...
This can be used to prove every priciple ultrafilter is generated by a singleton, or equivalentlly, every non-principle ultrafilter must contain the Frechet filter as a subset.
